...
import 'package:navigation_experimental/routes/guards/access_guard.dart';
        ...
        StatefulShellBranch(
          ...
          routes: [
            StatefulShellRoute(
              ...
              navigatorContainerBuilder: (context, officeNavigationShell, children) => OfficePage(
                navigationShell: officeNavigationShell,
                children: children,
              ),
              branches: [
                StatefulShellBranch(
